...
if ($contents -contains $pluginWatchPath) {
    throw "The Watch app is embedded in PlugIns, which regressed physical Watch discoverability through the iPhone Watch app. Rebuild with the Watch folder layout."
}
