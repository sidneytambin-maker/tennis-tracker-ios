...
enum TennisPrivacyPolicy {
    ...
    static let summary = "Your tennis library belongs to you. Tennis Tracker has no app account, shared community database, advertising or automatic analytics service."
    ...
    static let topics: [Topic] = [
        Topic(id: "library", title: "Your tennis library", text: "Tennis Tracker, developed by Inclusophy, stores the profiles, people, places, activities, notes, goals and preferences you enter on your device. These records power your history, statistics and achievements. Only enter information about other people that you are entitled to keep. New testers receive an empty library, never another player's records."),
        Topic(id: "watch", title: "Your paired Apple Watch", text: "Your iPhone and paired Apple Watch exchange your tennis records and settings using Apple's WatchConnectivity service. The Watch shares a local summary with its complication extension. This is not a public feed or a server operated by Inclusophy. Lock-screen notifications and watch-face complications can display activity details; you control their visibility in Apple's settings."),
        Topic(id: "health", title: "Optional Apple Health access", text: "When you choose a Health workout on Apple Watch, Tennis Tracker requests permission to read and write tennis workouts and supported measurements: heart rate, active energy, walking or running distance, and steps. It uses these to track your workout and saves its duration, available measurements and Health workout identifier with the session. That summary can sync to your paired iPhone. Basic tennis logging works without Health access. Health information is not sold or used for advertising. You can change access in Apple's Health and privacy settings."),
        ...
        Topic(id: "backup", title: "Private backups and sharing", text: "Export Private Backup creates a readable JSON file containing your tennis library, including saved workout summaries, but not the Apple Health database. The file is not password-encrypted by Tennis Tracker. You choose its destination and who can access it. Files saved to a cloud provider follow that provider's privacy settings. Keep exports private and delete copies you no longer need. Device backups are managed separately by your operating system."),
        ...
        Topic(id: "beta", title: "TestFlight and feedback", text: "Apple processes TestFlight installation, usage, crash and feedback information under its TestFlight privacy terms. Inclusophy can receive the beta feedback and diagnostic information Apple makes available to developers. Your whole tennis library is not automatically sent as feedback. Check screenshots and attachments for personal or Health details before sending them."),
        Topic(id: "contact", title: "Privacy questions", text: "For this beta, contact Inclusophy using Send Beta Feedback on Tennis Tracker's page in TestFlight. Ask privacy questions without attaching your library or Health information. Changes to this policy will be dated and published in the app and on the policy website. The website is hosted by GitHub Pages; GitHub processes website requests under its own privacy statement.")
    ]
}
